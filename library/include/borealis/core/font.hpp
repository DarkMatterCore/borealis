...
static const std::string FONT_CHINESE_SIMPLIFIED_REGULAR  = "schinese";    // regular Simplified Chinese font
static const std::string FONT_CHINESE_SIMPLIFIED_EXTENDED = "schineseext"; // extended Simplified Chinese font
static const std::string FONT_CHINESE_TRADITIONAL_REGULAR = "tchinese";    // regular Traditional Chinese font
